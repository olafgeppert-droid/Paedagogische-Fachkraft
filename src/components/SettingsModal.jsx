...
const SettingsModal = ({ settings, masterData, onSave, onSaveMasterData, onClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        // ALTE LOGIK ENTFERNT: document.body.classList.remove('light-theme', 'dark-theme', 'colored-theme');
        // NEU: Theme wird über data-theme Attribut gesteuert, nicht über Klassen
    };
    ...
    const resetToDefault = () => {
        setFormData({
            theme: 'hell', // STANDARD THEME GEÄNDERT
            fontSize: 16,
            inputFontSize: 16
        });
        setCustomColors({
        ...
        // Rücksprung zur Hauptansicht nach Klick auf "Standard"
        setTimeout(() => {
            onClose();
        }, 300);
    };
    ...
    return (
        <>
                ...
                <div className="modal settings-modal">
                    ...
                    <div className="modal-content">
                        <form onSubmit={handleSubmit}>
                            {/* Theme Section - Optimierte Darstellung */}
                            ...
                            {/* Schriftgrößen Section - Optimierte Darstellung */}
                            <div className="settings-section">
                                <h3>📝 Schriftgrößen</h3>
                            ...
                            {/* Stammdaten Section - Optimierte Darstellung */}
                            <div className="settings-section">
                                <h3>📊 Stammdaten</h3>
                            ...
                            {/* Modal Actions mit Standard-Button, der zur Hauptansicht zurückführt */}
            ...
            {/* Stammdaten Modal - Optimierte Darstellung */}
            {showMasterDataModal && (
                <div className="modal-overlay">
                    <div className="modal masterdata-modal">
                        ...
                        <div className="modal-content">
                            <form onSubmit={handleMasterDataSubmit}>
                                {/* Schuljahre Section - Optimierte Darstellung */}
                                ...
                                {/* Schulen und Klassen Section - Optimierte Darstellung */}
                                <div className="data-section">
